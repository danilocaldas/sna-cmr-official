...
public class PrestadorFrm extends javax.swing.JFrame {
     ...
     */
    PrestadorActionControl prestadorActionControl;
    public DefaultTableModel tmPrestador = new DefaultTableModel(null, new String[]{"Id", "Nome", "CNES"});
    ...
    public void mostrarPrestadores(List<Prestador> prestadores) {
    ...
    public void tbPrestadorLinhaSelecionada(JTable tb) {
    ...
    private void initComponents() {
        ...
        ftxtCnes = new JFormattedTextField(NumberFormat.getInstance());
