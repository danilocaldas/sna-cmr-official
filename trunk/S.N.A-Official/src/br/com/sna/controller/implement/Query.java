...
public class Query {
    ...
    String updateFuncionario = "UPDATE PROCEDIMENTOS SET NOME = ? , SET SENHA = ? WHERE ID = ?";
    //CRUD PROCEDIMENTO
    ...
    String updateProcedimento = "UPDATE PROCEDIMENTOS SET NOME = ?, SET CODIGO = ? WHERE ID = ?";
    //CRUD PRESTADOR
    ...
    String updatePrestador = "UPDATE FROM PRESTADOR SET CNES = ?, SET NOME = ? WHERE ID = ?";
    //CRUD PRODUCAO
    ...
    String updateProducao = "UPDATE PRODUCAO SET NOME_PROFISSIONAL = ?,SET NOME_PRESTADOR = ?, SET NOME_PROCEDIMENTO = ?, SET DATA_DIGITACAO = ?,"
            + "SET DATA_ENTRADA = ?, SET QUANTIDADE = ? WHERE ID = ?";
    //CRUD ARQUIVO
    ...
    String updateArquivo = "UPDATE FROM CAIXA SET ANO = ?, SET MES = ?, SET COR = ?, SET PRESTADOR = ?, SET PROCEDIMENTO = ? WHERE NUMERO = ?" ;
    //SOMA PRODUCAO
